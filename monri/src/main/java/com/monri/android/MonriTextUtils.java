...
public class MonriTextUtils {
     ...
     */
    @Nullable
    public static String removeNonDigits(@Nullable String cardNumberWithSpaces) {
        if (isBlank(cardNumberWithSpaces)) {
            return null;
        }
     ...
     */
    @Nullable
    public static String sha512HashInput(@Nullable String toHash) {
        if (MonriTextUtils.isBlank(toHash)) {
            return null;
        }
