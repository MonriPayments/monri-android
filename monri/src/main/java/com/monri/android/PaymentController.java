...
public interface PaymentController {
    ...
    void confirmPayment(ConfirmPaymentParams params, ActionResultConsumer<PaymentResult> resultCallback, int googleButtonType, int googleButtonTheme, int googleButtonCornerRadius);
